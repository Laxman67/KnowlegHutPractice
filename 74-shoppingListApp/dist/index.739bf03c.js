...
shoppingListDiv.addEventListener("click", function(evt) {
    ...
    if (evt.target.classList.contains("remove-btn")) {
        ...
        if ((0, _model.removeItem)(itemId)) (0, _view.renderShoppingList)();
    }
});
...
},{"./Item":"kap7m","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./model":"Y4A21"}],"kap7m":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
