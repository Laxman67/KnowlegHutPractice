...
parcelHelpers.export(exports, "addToCompletedList", ()=>addToCompletedList);
...
parcelHelpers.export(exports, "getCompletedList", ()=>getCompletedList);
parcelHelpers.export(exports, "bootUp", ()=>bootUp);
...
const bootUp = ()=>{
    const { active, completed } = (0, _storage.getFromStore)();
    shoppingList = active;
    completedList = completed;
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./storage":"h0qAZ"}],"gkKU3":[function(require,module,exports) {
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "saveToStore", ()=>saveToStore);
parcelHelpers.export(exports, "getFromStore", ()=>getFromStore);
...
parcelHelpers.export(exports, "renderCompletedList", ()=>renderCompletedList);
var _model = require("./model");
...
const renderCompletedList = ()=>{
    const domNodes = (0, _model.getCompletedList)().map(({ item, priority, id })=>{
        return (0, _itemDefault.default)(item, priority, id);
    });
    completedDiv.innerHTML = domNodes.join("");
};

},{"./model":"Y4A21","./Item":"kap7m","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kap7m":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
