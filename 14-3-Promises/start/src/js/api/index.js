const news = [
  {
    id: 1,
    content:
      "FarmTown: A car carrying two cows and a hen collided with a truck today. No one was hurt but the animals are on the loose.",
  },
  {
    id: 2,
    content:
  ...
  },
  {
    id: 4,
    content:
      "Medicine: A new virus known that makes people laugh like crazy has been found in the city of Melancholia.",
  },
  {
    id: 5,
    content:
